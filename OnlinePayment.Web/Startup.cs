...
namespace OnlinePayment.Web
{
    ...
    {       
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IPaymentDataAccess, PaymentDataAccess>();
            services.AddSingleton<SqlStringBuilder<Payment>>();
            #endregion

            #region register PaymentCallback
            services.AddTransient<IPaymentCallbackService, PaymentCallbackService>();
            services.AddTransient<IPaymentCallbackDataAccess, PaymentCallbackDataAccess>();
            services.AddSingleton<SqlStringBuilder<PaymentCallback>>();
            #endregion

            #region register PaymentRequest
            services.AddTransient<IPaymentRequestService, PaymentRequestService>();
            services.AddTransient<IPaymentRequestDataAccess, PaymentRequestDataAccess>();
            services.AddSingleton<SqlStringBuilder<PaymentRequest>>();
            #endregion

            #region register PaymentResponse
            services.AddTransient<IPaymentResponseService, PaymentResponseService>();
            services.AddTransient<IPaymentResponseDataAccess, PaymentResponseDataAccess>();
            services.AddSingleton<SqlStringBuilder<PaymentResponse>>();
            #endregion
    ...
    public class MappingConfiguration : Profile
    {
        public MappingConfiguration()
        {
                ...
                CreateMap<PaymentResponseViewModel, PaymentResponse>();
