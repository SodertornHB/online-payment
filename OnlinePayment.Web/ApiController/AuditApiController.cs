...
{ 
    ...
    {
        protected readonly ILogger<AuditController> logger;
        protected readonly IAuditService service;

        public AuditController(ILogger<AuditController> logger, IAuditService service)
        {
            this.logger = logger;
        ...
        {
            var item = JsonConvert.DeserializeObject<Audit>(value.ToString());
