...
{ 
    ...
    {
        protected readonly ILogger<PaymentController> logger;
        protected readonly IPaymentService service;
        ...
        {
            var item = JsonConvert.DeserializeObject<Payment>(value.ToString());
