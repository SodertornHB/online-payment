...
{ 
    ...
    [ApiController]
    public partial class PaymentResponseController: ControllerBase
    {
        protected readonly ILogger<PaymentResponseController> logger;
        protected readonly IPaymentResponseService service;

        public PaymentResponseController(ILogger<PaymentResponseController> logger, IPaymentResponseService service)
        {
            this.logger = logger;
        ...
        public async Task<IActionResult> Get([FromQuery] Dictionary<string, string> filters)
        {
            ...
            var modelType = typeof(PaymentResponse);
        ...
        {
            var item = JsonConvert.DeserializeObject<PaymentResponse>(value.ToString());
