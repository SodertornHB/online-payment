...
{ 
    ...
    [ApiController]
    public partial class PaymentCallbackController: ControllerBase
    {
        protected readonly ILogger<PaymentCallbackController> logger;
        protected readonly IPaymentCallbackService service;

        public PaymentCallbackController(ILogger<PaymentCallbackController> logger, IPaymentCallbackService service)
        {
            this.logger = logger;
        ...
        public async Task<IActionResult> Get([FromQuery] Dictionary<string, string> filters)
        {
            ...
            var modelType = typeof(PaymentCallback);
        ...
        {
            var item = JsonConvert.DeserializeObject<PaymentCallback>(value.ToString());
